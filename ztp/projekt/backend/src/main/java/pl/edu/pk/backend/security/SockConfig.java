...
public class SockConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/sock/endpoint").setAllowedOrigins("http://localhost:3000");
        registry.addEndpoint("/sock/endpoint").setAllowedOrigins("http://localhost:3000").withSockJS();
    }
}